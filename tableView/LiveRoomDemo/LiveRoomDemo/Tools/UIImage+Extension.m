...
+ (UIImage *)imageEffectLightFromImage:(UIImage *)inputImage
{
    ...
    return [self imageToImage:inputImage withRadius:60 tintColor:tintColor saturationDeltaFactor:1.8];
}

+ (UIImage *)imageEffectExtraLightFromImage:(UIImage *)inputImage
{
    UIColor *tintColor = [UIColor colorWithWhite:0.97 alpha:0.82];
    return [self imageToImage:inputImage withRadius:40 tintColor:tintColor saturationDeltaFactor:1.8];
}
...
+ (UIImage *)imageEffectTintFromImage:(UIImage *)inputImage andEffectColor:(UIColor *)tintColor
{
    ...
    return [self imageToImage:inputImage withRadius:20 tintColor:effectColor saturationDeltaFactor:-1];
}

#pragma mark - 实现方法
+ (UIImage *)imageToImage:(UIImage*)inputImage withRadius:(CGFloat)blurRadius tintColor:(UIColor *)tintColor saturationDeltaFactor:(CGFloat)saturationDeltaFactor
{
